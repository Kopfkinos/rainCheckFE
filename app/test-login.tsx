  ...
  export default function TestLogin() {
    ...
    const onSubmit= async (data: Inputs) => {
        ...
        try {
            ...
            const matchedUser = users.find((user: any) => user.username === data.username && user.password === data.password)
    ...
    return (
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input placeholder="Username" style={styles.usernameBox} {...register("username",{required: true})} />

        {errors.username && <Text style={styles.errorMessage}>Username is required</Text>}

        <input placeholder="Password" type={passwordVisible ? "text": "password"} style={styles.passwordBox}{...register("password", { required: true })} />
